 ...
 */
final class Version20240522234656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role (id INT NOT NULL, code VARCHAR(50) NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
